...
Dokument przygotowany~jest do~druku dwustronnego w~kolorze -- w~takim formacie każde~laboratorium zajmuje jedną kartkę,
opisując połączenia na~przedniej stronie, a~rozwiązania zadań (\ref{fig:compasssol},\ \ref{fig:distancesol},\ 
\ref{fig:alarmsol},\ \ref{fig:weathersol},\ \ref{fig:trafficsol}) na~tylnej.
...
\begin{figure}[H]
  \lstinputlisting[language=python,linerange={58-68},label={lst:compasssol}]{media/solved.py}
  \caption{Rozwiązania laboratorium I}
  \label{fig:compasssol}
\end{figure}
...
\begin{figure}[H]
  \lstinputlisting[language=python,linerange={73-106},label={lst:distancesol}]{media/solved.py}
  \caption{Rozwiązania laboratorium II}
  \label{fig:distancesol}
\end{figure}
...
\begin{figure}[H]
  \lstinputlisting[language=python,linerange={111-132},label={lst:alarmsol}]{media/solved.py}
  \caption{Rozwiązania laboratorium III}
  \label{fig:alarmsol}
\end{figure}
...
\begin{figure}[H]
  \lstinputlisting[language=python,linerange={137-169},label={lst:weathersol}]{media/solved.py}
  \caption{Rozwiązania laboratorium IV}
  \label{fig:weathersol}
\end{figure}
...
\begin{figure}[H]
  \lstinputlisting[language=python,linerange={174-230},label={lst:trafficsol}]{media/solved.py}
  \caption{Rozwiązania laboratorium V}
  \label{fig:trafficsol}
\end{figure}
