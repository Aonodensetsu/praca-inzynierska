\section{Laboratorium III}\label{sec:lab3}

\subsection{Wybrany sprzęt}\label{subsec:lab3-hw}

Podobnie do~poprzedniego laboratorium, w~tym~przypadku również wykorzystany~jest \emph{Grove Base Kit}.
...
Podłączony~jest do~portu cyfrowego, jego użycie polega na~analizie zboczy sygnału wyjściowego.
...
\subsection{Rozwiązanie}\label{subsec:lab3-sol}
...
\begin{figure}[H]
  ...
  \caption{Fragment instrukcji III}
  \label{fig:alarmlab}
\end{figure}

Rysunek~\ref{fig:alarm} przedstawia rozwiązanie instrukcji.
