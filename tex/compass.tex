...
termometr, higrometr, czujnik oświetlenia, joystick, oraz~matrycę $8\,\times\,8$ diod LED RGB\thinspace\cite{sensedoc}.
...
\begin{figure}[H]
  ...
  \caption{Podpowiedzi w interfejsie graficznym notatnika marimo}
