\section{Laboratorium II}\label{sec:lab2}

\subsection{Wybrany sprzęt}\label{subsec:lab2-hw}
...
może~służyć do~wyświetlenia danych pomocniczych lub~drugiego rekordu.
Wyświetlacz~ten jest~zaprojektowany do~obsługi tekstu i~nie~można wykorzystać pikseli do~dowolnego rysowania.

\subsection{Dodatkowe oprogramowanie}\label{subsec:lab2-sw}
...
możliwa~jest prosta instalacja (rys.~\ref{fig:seeed}) przy~użyciu stosunkowo nowych wersji oficjalnego menedżera
bibliotek.
...
\subsection{Rozwiązanie}\label{subsec:lab2-sol}
...
\begin{figure}[H]
  ...
  \caption{Fragment instrukcji II}
