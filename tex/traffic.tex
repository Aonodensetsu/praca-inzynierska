...
W związku z~tą cechą, moduły \emph{pHAT} należy traktować jako~zbiór osobnych elementów elektronicznych
...
W~przykładowym rozwiązaniu wiadomości~te zawierają~jedną ze~zdefiniowanych możliwych wartości uruchamiających
poszczególne przejścia stanu -- czerwony-zielony, zielony-czerwony, zakończenie działania programu.
