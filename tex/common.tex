...
\begin{table}[H]
  \caption{Cechy \emph{marimo} wynikające z~braków w~innych rozwiązaniach}
...
w~tym pliku PDF, w~Archiwum Prac Dyplomowych, jak~i na~mojej~stronie Internetowej\thinspace\cite{script}.
...
Dokumentacja procesu tworzenia pracy, a~także pliki pomocnicze wykorzystane przez autora są~dostępne w~repozytorium
archiwalnym\thinspace\cite{repo}.
