...
połączenie elementów sprzętowych laboratoriów.

W~celu pokazania pełnej treści laboratoriów dołączony~jest również plik zawierający pełne zdjęcia instrukcji studenckich 
\ax{instrukcje.pdf}{instrukcje.pdf}[mimetype=application/pdf].
