...
prostokątnym o~stałej częstotliwości i~amplitudzie jako~szerokości poszczególnych impulsów elektrycznych.
...
Wiadomość UART składa~się z~zakończenia domyślnego trybu wysokiego nieczynnej linii (stanem niskim) o~czasie trwania
równym jednemu bitowi, a~następnie przesłanie 5--9 bitów wiadomości i~opcjonalnego bitu parzystości.
